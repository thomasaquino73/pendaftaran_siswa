    ...
    <div class="col-12 col-md-12 col-lg-12 col-xl-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title d-inline-block">Employee</h4>
                <a href="javascript:void(0);" id="create" type="button"
    ...
    <div class="col-12 col-md-12 col-lg-12 col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="karyawan" class=" table-primary ">
                        <thead>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <select name="kabupaten" id="kabupaten"
                                                        class="form-select single-select-field2" style="width:100%"
