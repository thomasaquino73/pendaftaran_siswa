...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{ asset('') }}assets/snapx/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">


    <!-- Additional CSS Files -->
    <link rel="stylesheet" href="{{ asset('') }}assets/snapx/css/fontawesome.css">
    <link rel="stylesheet" href="{{ asset('') }}assets/snapx/css/templatemo-snapx-photography.css">
    <link rel="stylesheet" href="{{ asset('') }}assets/snapx/css/owl.css">
    <link rel="stylesheet" href="{{ asset('') }}assets/snapx/css/animate.css">
...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <img src="{{ asset('').$dataperusahaan->logo }}" height="50px" width=40px alt="">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="owl-features owl-carousel" style="position: relative; z-index: 5;">
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ asset('') }}assets/snapx/images/featured-01.jpg" alt="">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ asset('') }}assets/snapx/images/featured-02.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="content">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ asset('') }}assets/snapx/images/featured-03.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="content">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright © 2024 <a href="#">{{ $dataperusahaan->namaperusahaan  }}</a> All rights reserved.
                </div>
            </div>
        </div>
    </footer>
    ...
    <script src="{{ asset('') }}assets/snapx/vendor/jquery/jquery.min.js"></script>
    <script src="{{ asset('') }}assets/snapx/vendor/bootstrap/js/bootstrap.min.js"></script>

    <script src="{{ asset('') }}assets/snapx/js/isotope.min.js"></script>
    <script src="{{ asset('') }}assets/snapx/js/owl-carousel.js"></script>

    <script src="{{ asset('') }}assets/snapx/js/tabs.js"></script>
    <script src="{{ asset('') }}assets/snapx/js/popup.js"></script>
    <script src="{{ asset('') }}assets/snapx/js/custom.js"></script>
