        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('siswa.store') }}" id="postForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input class="form-control  @error('fullnamestudent') is-invalid : is-valid @enderror"
                                    type="text" name="fullnamestudent" value="{{ old('fullnamestudent') }}">
                                <span class="text-danger error-text fullnamestudent_error"> </span>
                                {{-- <span class="text-danger error-text full_name_student_error"> </span> --}}
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="cal-icon">
                                        <input value="{{ old('dobstudent') }}" name="dobstudent" type="text" class="form-control datepicker" readonly>
                            ...
                            <div class="form-group">
                                <div class="form-group ">
                                    ...
                                    <div class="form-check">
                                        <label>
                                            <input name="medical_conditions" type="radio" id="r1"
                    ...
                    <button id="add" name="add" type="button" class="btn btn-primary add mt-3 ">Add
                        Data</button>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('.add').click(function() {
                    ...
                    $('.block:last').after(
                        '<div class="block" style="border-bottom: 2px dashed rgb(211, 211, 211); padding:20px">' +
                        '<h2>Contact </h2><button type = "button"class = "btn btn red btn-rounded float-right remove">' +
                        '<i class = "fa fa-trash" > </i> Delete</button > <div class = "row" > <div class ="col-lg-6" > ' +
                        '<div class = "form-group" ><label> Full Name </label> <input class = "form-control" type = "text" name = "full_name_parent[]"id = "full_name_parent[]" ></div> </div > <div class = "col-lg-6" ><div class = "form-group" >' +
                        '<label> Family Name </label> <input class = "form-control"type = "text"name = "family_name_parent[]"id = "family_name_parent" > </div> </div > <div class = "col-lg-6" ><div class = "form-group" ><div class = "form-group " ><label> Relationship </label> <select name = "gender_parent"id = "gender_parent" class ="form-select single-select-field1" data - placeholder = "Choose Relationship ..."style = "width:100%" >' +
                        '<option > </option> <option value = "Father" > Father </option> <option value = "Mother" > Mother </option> <option value = "Grandparent" > Grandparent </option> <option value = "Guardian" > Guardian </option> <option value = "Others" > Others </option> </select > <span class = "text-danger error-text gender_parent_error" > </span> </div > </div> </div > <div class = "col-lg-6" ><div class = "form-group" ><label> Email </label> <input type = "email"class = "form-control "name = "email_parent"id = "email_parent" ></div> </div> <div class = "col-lg-6" ><div class = "form-group" ><label> Phone(Mobile / Home) </label> <input class = "form-control"type = "text"name = "full_name_parent" id = "full_name_parent" ></div> </div > <div class = "col-lg-6" ><div class = "form-group" > <label> Phone Office </label> <input class = "form-control"type = "text" name = "family_name_parent" id = "family_name_parent" > </div> </div ></div> </div > '
                    );
                });
